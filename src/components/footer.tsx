    ...
    return (
        <div id="footer" className="relative bg-[#583671]">
            <div className="relative w-full flex flex-col-reverse md:flex-row pt-10">
                <div className="flex-1 pl-16">
                    ...
                    <div className="relative w-full flex pt-5 justify-start">
                        <a href="https://web.facebook.com/profile.php?id=100031324907198" className="pr-5"><img src="/images/icon.png" alt="Logiciel Applab Facebook"/></a>
                        <a href="https://www.instagram.com/logicielapplab/ " className=""><img src="/images/icon.png" alt="Logiciel Applab Instagram"/></a>
                    </div>
                </div>
            ...
            <div className="w-full mt-5 h-5" >
                <h6 className="text-white text-center text-xs">® Logicel Applab - Todos los derechos reservados.</h6>
            </div>
        </div>
    );
}
